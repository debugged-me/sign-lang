...
<div class="navbar-custom">
    ...
    <!-- LOGO -->
    <div class="logo-box">
        <a href="<?= base_url('FSL') ?>" class="logo text-center">
            <span class="logo-lg">
                <img src="<?= base_url('upload/banners/logo-banner.png') ?>" alt="FSL Logo" style="max-height: 40px; width: auto; object-fit: contain;">
            </span>
            <span class="logo-sm">
                <img src="<?= base_url('upload/banners/logo-banner.png') ?>" alt="FSL Logo" style="max-height: 32px; width: auto; object-fit: contain;">
            </span>
        </a>
    </div>
